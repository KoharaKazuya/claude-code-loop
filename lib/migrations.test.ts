...
describe("migrateConfig", () => {
  it("schemaVersion 欠損の config を 1 へ移行する", () => {
...
describe("V1_DEFAULTS と雛形 config.json", () => {
  it("キー集合が一致する(雛形だけにフィールドが増えて移行から漏れるのを防ぐ)", () => {
    ...
    expect(Object.keys(template).sort()).toEqual(["schemaVersion", ...Object.keys(V1_DEFAULTS)].sort());
