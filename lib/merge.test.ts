...
describe("classifyConflicts", () => {
  ...
  it(".agent/decisions/index.md が add/add(stage {2,3})なら decisionsIndex として mechanical", () => {
  ...
  it(".agent/decisions/index.md が modify/modify(stage {1,2,3})でも decisionsIndex として mechanical", () => {
